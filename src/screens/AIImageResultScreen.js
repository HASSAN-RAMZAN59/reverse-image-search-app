  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          {selectedImageData?.loading ? (
            ...
            <Image source={{ uri: selectedImageData?.uri }} style={styles.mainPreviewImage} />
          )}
        </TouchableOpacity>
              ...
              {images.map((item) => (
                ...
                >
                  {item.loading ? (
                    ...
                    <Image source={{ uri: item.uri }} style={styles.variationThumbnail} />
                  )}
                </TouchableOpacity>
              ))}
            </ScrollView>
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity style={styles.generateMoreBtn} onPress={runGenerations}>
